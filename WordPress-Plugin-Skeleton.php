 ...
 */
function activate_wordpress_plugin_skeleton()
{
 ...
 */
function deactivate_wordpress_plugin_skeleton()
{
  require_once realpath(plugin_dir_path(__FILE__) . 'model/deactivator.php');
  Deactivator::deactivate();
}

register_activation_hook(__FILE__, 'activate_wordpress_plugin_skeleton');
register_deactivation_hook(__FILE__, 'deactivate_wordpress_plugin_skeleton');
